...
TwitterAccountVerification.prototype.accountExists = function (twitter_id) {
    return __awaiter(this, void 0, void 0, function () {
        var check;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, twitterAccountsDAO.getAccount_id(twitter_id)];
                case 1:
                    check = _a.sent();
                    if (check)
...
TwitterAccountVerification.prototype.linkExists = function (linkAccountDTO) {
    return __awaiter(this, void 0, void 0, function () {
        var check;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, twitterAccountAccessDAO.checkLink(linkAccountDTO)];
                case 1:
                    check = _a.sent();
