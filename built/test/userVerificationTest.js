...
var config = require('../configs/mainConfig.js');
            ...
            it('should return true', function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, userVerification.verifyUsername('test')];
                            case 1:
                                userExists = _a.sent();
        ...
        context('Username does not exist in database', function () {
            it('should return false', function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, userVerification.verifyUsername('NotAnAccount')];
                            case 1:
                                userExists = _a.sent();
