...
Cryptography.prototype.decipher = function (encryptedText) {
    ...
    try {
        if (typeof encryptedText === 'number') encryptedText = encryptedText.toString();
        else if (typeof encryptedText != 'string') throw TypeError;
